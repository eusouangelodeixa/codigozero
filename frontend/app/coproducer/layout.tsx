...
import { LayoutGrid, BarChart3, Users as UsersIcon, Send, LogOut, ExternalLink, Copy, Settings, Bell, GraduationCap } from "lucide-react";
...
const NAV = [
  ...
  { href: "/coproducer/cursos",   label: "Cursos",      icon: <GraduationCap size={17} /> },
  { href: "/coproducer/notifications", label: "Notificações", icon: <Bell size={17} /> },
